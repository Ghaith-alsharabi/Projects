...
session_summary_df = pd.read_csv(
    "sport/basketballApp/basketballDashboard/basketballApps/database/full_session_summary.csv",
    delimiter=";",
)
...
full_rpe_df = pd.read_csv(
    "sport/basketballApp/basketballDashboard/basketballApps/database/rpe_data.csv",
    delimiter=";",
    encoding="latin1",
)
...
right_eye_df = pd.read_csv(
    "sport/basketballApp/basketballDashboard/basketballApps/database/rightEyeTransformed.csv",
    delimiter=";",
    encoding="latin1",
)  # encoding="latin1")
